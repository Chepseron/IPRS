                    ...
                    <div id="login_content">
                            ...
                            <h:form id="abmt_reg_form09"   style="width: 102%; margin-right auto; margin-right: auto;   padding:0; ">
                                ...
                                <div id="chnage_container" align="center">
                                    <div class="headline">Change Expired Password</div>
                                    ...
                                    <h:panelGrid id="send_to" columns="2" >
                                        ...
                                        <h:outputText id="username2" value="#{immigration.username}"  />
                                        </div>
                                        <div class="text_lines">
                                        <font size="2px" color="white"> Old Password</font>
                                        <h:inputSecret id="pass1" value="#{immigration.pass}"/>
                                        </div>
                                        <div class="text_lines">
                                    ...
                                    <h:commandButton value="Change Password" action="#{immigration.change_password}"/>
