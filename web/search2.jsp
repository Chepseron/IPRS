                    ...
                    <rich:layoutPanel position="center" width="400%" id ="main" >
                        <rich:panel style="background: transparent">
                            ...
                            <h:form id="from2" style="width:800px">
                                ...
                                <h:panelGrid>
                                    <rich:tabPanel>
                                        <rich:tab label="Id Details">
                                            ...
                                            <rich:dataTable id="usertable5" rows="20" binding="#{immigration.humantable}"
                                                ...
                                                <rich:column >
                                                    ...
                                                    <h:commandLink value="Detail"  action="#{immigration.detail2}"/>
                                                </rich:column>
                                        ...
                                        <rich:tab label="Passport Details">
                                            <rich:datascroller maxPages="200" id="pinless1239898" for="usertable59"/>
                                            <rich:dataTable id="usertable59" rows="20" binding="#{immigration.passportable}"
                                                            onRowMouseOver="this.style.backgroundColor='#F1F1F1'"
                                                            onRowMouseOut="this.style.backgroundColor='#{a4jSkin.tableBackgroundColor}'"
                                                            cellpadding="0" cellspacing="0"
                                                ...
                                                <rich:column >
                                                    <f:facet name="header"><h:outputText value="Detail" /></f:facet>
                                                    <h:commandLink value="Detail"  action="#{immigration.passportdetails}"/>
                                                </rich:column>
                                        ...
                                        <rich:tab label="Other Result">
                                            ...
                                            <rich:dataTable id="doubletable" rows="20" binding="#{immigration.doubletable}"
                                                ...
                                                <rich:column >
                                                    <f:facet name="header"><h:outputText value="Detail" /></f:facet>
                                                    <h:commandLink value="Detail"  action="#{immigration.doubledetails}"/>
                                                </rich:column>
                                ...
                                <h:commandButton value="back" action="/search.jsp" /><br>
