                                        ...
                                        <div class="pages_container">
                                            <h:panelGrid columns="1">
                                                ...
                                                <h:panelGrid  columns="2">
                                                    ...
                                                    <rich:dataTable id="deaths" rows="2">
                                                        <rich:column >
                                                            <f:facet name="header"><h:outputText value="Year Of Death" /></f:facet>
                                                            <h:outputText   value="#{immigration.human.yearDeath}" />
                                                        </rich:column>
                                                        <rich:column >
                                                            <f:facet name="header"><h:outputText value="Month Of Death" /></f:facet>
                                                            <h:outputText   value="#{immigration.human.monthDeath}" />
                                                        </rich:column>
                                                        <rich:column >
                                                            <f:facet name="header"><h:outputText value="Day Of Death" /></f:facet>
                                                            <h:outputText   value="#{immigration.human.dayDeath}" />
                                                        </rich:column>
                                                        <rich:column >
                                                            <f:facet name="header"><h:outputText value="Date Of Death" /></f:facet>
                                                ...
                                                <h:panelGrid columns="2" styleClass="text" >
                                                    ...
                                                    <h:outputText   value="#{immigration.human.dateModified}" >
                                                        <f:convertDateTime pattern="dd-MM-yyyy"/>
                                                    </h:outputText>
                                                    <h:outputText  value="Modified By:" />
                                                    <h:outputText  value="#{immigration.human.modifiedBy}" >                                                    
                                                    </h:outputText>
